...
- publish reproducible benchmarks against aria2c and other download engines, including throughput, CPU, memory, retry behavior and integrity under latency and packet loss;
