Warning: truncated output (original token count: 57964)
Total output lines: 6654
...
fn parse_aria2_progress(text: &str) -> Option<(u64, u64, f64, u64, u64, u64, u64, Option<String>)> {
    text.lines().rev().find_map(|line| {
        ...
        let connecti…7964 tokens truncated… let ffprobe_valid = id != "ffmpeg" || version_line(&ffprobe, &["-version"]).is_some();
