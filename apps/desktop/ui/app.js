const catalogs = {
  en: {
    ...
    linkShareNotice: "Share a file, folder or mapped drive here. Windows SMB shared folders are also discovered automatically.",
  ...
  "zh-CN": {
    ...
    linkShareNotice: "可在此共享文件、文件夹或映射驱动器；Windows SMB 已共享的文件夹也会自动显示。",
