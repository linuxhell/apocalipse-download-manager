(function (root, factory) {
  ...
  const copy = {
    en: {
      ...
      toolsHelp: "Tools manages FFmpeg, FFprobe, yt-dlp, aria2, rqbit, N_m3u8DL-RE, QuickJS and your external media player.",
    ...
    "pt-BR": {
      ...
      toolsHelp: "Ferramentas administra FFmpeg, FFprobe, yt-dlp, aria2, rqbit, N_m3u8DL-RE, QuickJS e o seu player externo.",
    ...
    "zh-CN": {
      ...
      toolsHelp: "“工具”用于管理 FFmpeg、FFprobe、yt-dlp、aria2、rqbit、N_m3u8DL-RE、QuickJS 和你的外部播放器。",
  ...
  function debuggerDomainDiagnosis(question, context, locale) {
    ...
    const domains = [
      ...
      { name: "rqbit", test: /rqbit|torrent|magnet/, event: /^(?:rqbit\.|torrent\.)/ },
